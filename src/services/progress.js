...
import { getLevel, computeXpForChallenge, updateStreak, checkBadges, pickDailyChallenge } from './gamify.js'
...
export async function startChallenge(challenge) {
...
export async function completeChallenge(challenge, score, hintsUsed) {
...
export async function useHint(challengeId) {
...
export async function loadDaily(challenges) {
  let settings = await db.get('settings', 'default')
